...
class KistingsControllerTest < ActionController::TestCase
  ...
  test "should create kisting" do
    assert_difference('Kisting.count') do
      post :create, kisting: { description: @kisting.description, name: @kisting.name, price: @kisting.price }
    end
  ...
  test "should update kisting" do
    patch :update, id: @kisting, kisting: { description: @kisting.description, name: @kisting.name, price: @kisting.price }
    assert_redirected_to kisting_path(assigns(:kisting))
  end
