...
class SistingsControllerTest < ActionController::TestCase
  ...
  test "should create sisting" do
    assert_difference('Sisting.count') do
      post :create, sisting: { description: @sisting.description, name: @sisting.name, price: @sisting.price }
    end
  ...
  test "should update sisting" do
    patch :update, id: @sisting, sisting: { description: @sisting.description, name: @sisting.name, price: @sisting.price }
    assert_redirected_to sisting_path(assigns(:sisting))
  end
